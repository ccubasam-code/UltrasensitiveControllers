...
plot([0 1 1 2 2 3]*Tmax,[r1 r1 r2 r2 r3 r3]*thc/kc/Omega,'-','Color',[102 103 102]/255,'LineWidth',4)
% plot([0 1 1 2 2 3]*Tmax,[r1 r1 r2 r2 r3 r3],'-','Color',[102 103 102]/255,'LineWidth',4)
