...
ax.YTick = [0 round(s1(end,4)*10)/10 round(UT*10)/10];

%
u_v = logspace(-6,-0.0004,N)*ut; %e_v(end) = [];
y_v = logspace(-2,0,N)*trs/ds*as/phs;
...
ax.YTick = [0 round(s2(end,4)*10)/10 round(UT*10)/10];

%
u_v = logspace(-6,-0.002,N)*ut; %e_v(end) = [];
y_v = logspace(-2,0,N)*trs/ds*as/phs;
...
ax.YTick = [0 round(s3(end,4)*10)/10 round(UT*10)/10];
